    ...
    public class Product_CFG : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { ID = 4, ProductName = "Köfte Burger", CategoryID = 1, Price = 20, IsActive = true},
                new Product { ID = 5, ProductName = "Tavuk Burger", CategoryID = 1, Price = 20, IsActive = true},
                new Product { ID = 6, ProductName = "Mayonez", CategoryID = 3, Price = 20, IsActive = true}
                );
        }
    }
}
